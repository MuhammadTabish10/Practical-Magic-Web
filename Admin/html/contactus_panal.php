            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-6">
                        ...
                        <h1 class="mb-0 fw-bold">Contact us</h1>
                    </div>
                    <div class="col-6">
                    </div>
                </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <form action="../../db/checkdata.php" method="POST">
                                                ...
                                                <td><button class="DltBtn" name="ContactDltButton">DELETE</button></td>
                                            </form>
                                            <form action="update.php" method="POST">
                                                <input type="hidden" name='ID' value="<?php echo $row['ID']?>">
                                                <td><input type="submit" class="EditBtn" name="ContactEditButton" value="EDIT"></td>
                                            </form>
